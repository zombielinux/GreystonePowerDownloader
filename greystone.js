...
got('https://secure.greystonepower.com/oscp/customizations/MDM/ExportCSV.aspx?IsNew=Y&id=Interval&mbrsep=' + secrets.memberNumber + '&stdate=' + startDate +'&interval=15&sliderval=0&meter=' + secrets.meterNumber + '&demandcode=00').then(response => { 
